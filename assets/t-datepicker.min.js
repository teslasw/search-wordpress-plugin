...
var newDate=new Date(date.getFullYear(),(date.getMonth()+i_num));tswitch[i_num].innerHTML=settings.titleMonths[newDate.getMonth()]+' '+newDate.getFullYear();var dataDays=[];var dataUTCDate=[];var days=[];var nextDate=Date(date.getFullYear(),(date.getMonth()+i_num));var date=new Date(nextDate)
...
if(Date(y,m+numCalendar)===limitNextMonth||new Date(y,m+numCalendar).getMonth()===new Date(dataUTC[0]).getMonth()+1){Arrow_2[Arrow_2.length-1].className='t-arrow t-next t-disabled'}

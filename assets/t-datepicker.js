...
;(function($){
  ...
  $.fn.tDatePicker = function( pr_el, options ) {
    ...
    function setDaysInMonth ( pr_el, pr_data_utc ) {
      ...
      console.log('setDaysInMonth',pr_el, pr_data_utc);
    ...
    //   if(end_Date == null)
      var  end_Date = new Date ( df_toDay.getFullYear(), df_toDay.getMonth() + settings.numCalendar + settings.limitNextMonth - 1, df_toDay.getDate());
    //   var end_Date = new Date(convertFormatDf(settings.endDate)) // nếu = null thì lấy setStart làm chuẩn
      ...
      var limitNextMonth = Date.UTC(end_Date.getFullYear(), end_Date.getMonth()) || Date.UTC(df_toDay.getFullYear(), df_toDay.getMonth() + numCalendar + settings.limitNextMonth);
        console.log('pr_data_utc',pr_data_utc);
